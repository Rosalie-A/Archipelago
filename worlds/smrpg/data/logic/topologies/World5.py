...
from ..SMRPGLocation import SMRPGLocation, LocationNames, InvisibleFlagLocation, UnusedLocation, StarPieceLocation, \
    BossFightLocation, RemakeBossFightLocation, RemakeStarPieceLocation, RemakeLocation, EXPStarLocation
...
LandsEnd.locations = [
    ...
    SMRPGLocation(LocationNames.LANDS_END_BEE_ROOM_CHEST),
    ...
    SMRPGLocation(LocationNames.LANDS_END_CHOW_PIT_LEFT_CHEST),
    SMRPGLocation(LocationNames.LANDS_END_CHOW_PIT_RIGHT_CHEST),
    SMRPGLocation(LocationNames.LANDS_END_CLIFF_BUSH_FLAG),
    SMRPGLocation(LocationNames.LANDS_END_FIRST_CHEST),
    SMRPGLocation(LocationNames.LANDS_END_GROTTO_CORNER_CHEST),
    SMRPGLocation(LocationNames.LANDS_END_GROTTO_NEAR_SEWER_CHEST),
    SMRPGLocation(LocationNames.LANDS_END_GROTTO_FIRST_CHEST),
...
BelomeTemple.locations = [
    SMRPGLocation(LocationNames.BELOME_TEMPLE_AFTER_FORTUNE_AREA_LOWER_LEFT_CHEST),
    SMRPGLocation(LocationNames.BELOME_TEMPLE_AFTER_FORTUNE_AREA_MIDDLE_CHEST),
    SMRPGLocation(LocationNames.BELOME_TEMPLE_AFTER_FORTUNE_AREA_RIGHT_CHEST),
    SMRPGLocation(LocationNames.BELOME_TEMPLE_AFTER_FORTUNE_AREA_UPPER_LEFT_CHEST),
    SMRPGLocation(LocationNames.BELOME_TEMPLE_FIRST_FORTUNE_TELLING_ROOM_CHEST),
    SMRPGLocation(LocationNames.BELOME_TEMPLE_LEFT_MIDDLE_RIGHT_FORTUNE_CHEST),
    SMRPGLocation(LocationNames.BELOME_TEMPLE_LEFT_RIGHT_MIDDLE_FORTUNE_CHEST),
    SMRPGLocation(LocationNames.BELOME_TEMPLE_RIGHT_LEFT_MIDDLE_FORTUNE_CHEST),
    SMRPGLocation(LocationNames.BELOME_TEMPLE_RIGHT_MIDDLE_LEFT_FORTUNE_CHEST),
]
...
BeanValley.locations = [
    ...
    SMRPGLocation(LocationNames.BEAN_VALLEY_BOTTOM_RIGHT_PIRANHA_PIPE_UPPER_CHEST),
    SMRPGLocation(LocationNames.BEAN_VALLEY_CHEST_ABOVE_BOX_BOYS_ROOM),
    InvisibleFlagLocation(LocationNames.BEAN_VALLEY_CLOUDS_FLAG),
    SMRPGLocation(LocationNames.BEAN_VALLEY_CLOUDS_LOWER_LEFT_CHEST),
    SMRPGLocation(LocationNames.BEAN_VALLEY_CLOUDS_LOWER_RIGHT_CHEST),
    SMRPGLocation(LocationNames.BEAN_VALLEY_CLOUDS_SOLO_VINE_CHEST),
    SMRPGLocation(LocationNames.BEAN_VALLEY_CLOUDS_UPPER_LEFT_CHEST),
    SMRPGLocation(LocationNames.BEAN_VALLEY_CLOUDS_UPPER_RIGHT_CHEST),
    ...
    SMRPGLocation(LocationNames.BEAN_VALLEY_LEFT_PIRANHA_PIPE_CHEST),
    ...
    SMRPGLocation(LocationNames.BEAN_VALLEY_NORTH_UPPER_LEVEL_CHEST),
    ...
    SMRPGLocation(LocationNames.BEAN_VALLEY_RIGHT_PIRANHA_PIPE_LEFT_CHEST),
    SMRPGLocation(LocationNames.BEAN_VALLEY_RIGHT_PIRANHA_PIPE_RIGHT_CHEST),
    SMRPGLocation(LocationNames.BEAN_VALLEY_SOUTH_UPPER_LEVEL_CHEST),
