...
SeasideTown.locations = [
    ...
    SMRPGLocation(LocationNames.SEASIDE_TOWN_SHED_RESCUE, [HasSeasideTown]),
]
...
Sea.locations = [
    ...
    SMRPGLocation(LocationNames.SEA_SAVE_ROOM_BACK_CHEST),
    SMRPGLocation(LocationNames.SEA_SAVE_ROOM_FRONT_CHEST),
    SMRPGLocation(LocationNames.SEA_SAVE_ROOM_MIDDLE_CHEST),
    ...
    SMRPGLocation(LocationNames.SEA_WHIRLPOOL_ROOM_CHEST),
]
...
SunkenShip.locations = [
    ...
    SMRPGLocation(LocationNames.SUNKEN_SHIP_CLONE_ROOM_CHEST),
    ...
    SMRPGLocation(LocationNames.SUNKEN_SHIP_HIDDEN_BOX_ROOM_CHEST),
    SMRPGLocation(LocationNames.SUNKEN_SHIP_HIDDEN_UNDERWATER_ROOM_CHEST),
    SMRPGLocation(LocationNames.SUNKEN_SHIP_HIDONS_ROOM_LEFT_CHEST),
    SMRPGLocation(LocationNames.SUNKEN_SHIP_HIDONS_ROOM_RIGHT_CHEST),
    SMRPGLocation(LocationNames.SUNKEN_SHIP_LARGE_POOL_FREESTANDING_FROG_COIN),
    SMRPGLocation(LocationNames.SUNKEN_SHIP_NEAR_FINAL_BOSS_CHEST),
    SMRPGLocation(LocationNames.SUNKEN_SHIP_OUTSIDE_CLONE_ROOM_LEFT_CHEST),
    SMRPGLocation(LocationNames.SUNKEN_SHIP_OUTSIDE_CLONE_ROOM_RIGHT_CHEST),
    ...
    SMRPGLocation(LocationNames.SUNKEN_SHIP_SHOP_AREA_CHEST),
