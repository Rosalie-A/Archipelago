...
boss_locations: list[LocationNames] = [
    ...
    LocationNames.NIMBUS_LAND_STATUE_KEEPER_BOSS_FIGHT,
    LocationNames.NIMBUS_LAND_GIANT_EGG_BOSS_FIGHT,
...
star_piece_locations: list[LocationNames] = [
    ...
    LocationNames.NIMBUS_LAND_STATUE_KEEPER_BOSS_STAR_PIECE,
    LocationNames.NIMBUS_LAND_GIANT_EGG_BOSS_STAR_PIECE,
