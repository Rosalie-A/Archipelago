...
locations_data = [
    ...
    ("Mushroom Kingdom Vault 1", SMRPGRegions.mushroom_kingdom),
    ("Mushroom Kingdom Vault 2", SMRPGRegions.mushroom_kingdom),
    ("Mushroom Kingdom Vault 3", SMRPGRegions.mushroom_kingdom),
    ...
    ("Booster Tower Top 1", SMRPGRegions.booster_tower),
    ("Booster Tower Top 2", SMRPGRegions.booster_tower),
    ("Booster Tower Top 3", SMRPGRegions.booster_tower),
