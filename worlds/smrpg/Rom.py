...
location_data: Dict[str, MemoryLocation] = dict({
    ...
    "Mario's Bed": MemoryLocation(0x2DC0, 4, True),
    "Croco 1": MemoryLocation(0x304D, 3, True),
    "Rare Frog Coin Reward": MemoryLocation(0x3083, 4, True),
    "Melody Bay Song 1": MemoryLocation(0x3051, 4, False),
    "Melody Bay Song 2": MemoryLocation(0x3054, 5, False),
    "Melody Bay Song 3": MemoryLocation(0x3054, 6, True),
    "Rose Town Sign": MemoryLocation(0x2D68, 2, True),
    "Yo'ster Isle Goal": MemoryLocation(0x2D3A, 0, True),
    "Croco 2": MemoryLocation(0x3056, 5, False),
    "Booster Tower Ancestors": MemoryLocation(0x2DCB, 7, True),
    "Booster Tower Checkerboard": MemoryLocation(0x3054, 2, False),
    "Knife Guy": MemoryLocation(0x3099, 6, True),
    "Seaside Town Key": MemoryLocation(0x2E19, 3, True),
    "Monstro Town Key": MemoryLocation(0x3092, 7, True),
    "Nimbus Land Castle Key": MemoryLocation(0x305F, 6, True),
    "Birdo": MemoryLocation(0x305F, 5, False),
    "Fertilizer": MemoryLocation(0x2E6F, 5, True),
    ...
    "Wallet Guy 1": MemoryLocation(0x3083, 2, True),
    "Wallet Guy 2": MemoryLocation(0x3083, 2, True),
    "Mushroom Kingdom Store": MemoryLocation(0x3089, 6, True),
    "Peach Surprise": MemoryLocation(0x3084, 4, True),
    "Invasion Family": MemoryLocation(0x3082, 6, True),
    "Invasion Guest Room": MemoryLocation(0x3083, 0, False),
    "Invasion Guard": MemoryLocation(0x3082, 5, True),
    "Croco 1 Reward": MemoryLocation(0x3082, 5, True),
    "Pandorite Reward": MemoryLocation(0x3057, 5, True),
    "Midas River First Time": MemoryLocation(0x3043, 3, False),
    "Rose Town Toad": MemoryLocation(0x3084, 0, False),
    "Gaz": MemoryLocation(0x3085, 7, True),
    "Treasure Seller 1": MemoryLocation(0x3088, 1, True),
    "Treasure Seller 2": MemoryLocation(0x3088, 0, True),
    "Treasure Seller 3": MemoryLocation(0x3088, 2, True),
    "Croco Flunkie 1": MemoryLocation(0x3057, 0, True),
    ...
    "Booster Tower Chomp": MemoryLocation(0x2DCB, 7, True),
    "Booster Tower Curtain Game": MemoryLocation(0x3053, 5, False),
    "Seaside Town Rescue": MemoryLocation(0x3086, 6, True),
    "Sunken Ship 3D Maze": MemoryLocation(0x307D, 2, True),
    "Sunken Ship Cannonball Puzzle": MemoryLocation(0x307D, 1, False),
    "Sunken Ship Hidon Reward": MemoryLocation(0x3057, 7, False),
    "Belome Temple Treasure 1": MemoryLocation(0x2E67, 5, True),
    "Belome Temple Treasure 2": MemoryLocation(0x2E67, 6, False),
    "Belome Temple Treasure 3": MemoryLocation(0x2E67, 7, True),
    "Jinx Dojo Reward": MemoryLocation(0x308A, 5, True),
    "Culex Reward": MemoryLocation(0x3093, 4, True),
    "Super Jumps 30": MemoryLocation(0x3092, 0, True),
    "Super Jumps 100": MemoryLocation(0x3092, 2, False),
    "Three Musty Fears": MemoryLocation(0x3089, 7, False),
    "Troopa Climb": MemoryLocation(0x3094, 7, True),
    "Dodo Reward": MemoryLocation(0x3093, 1, False),
    "Nimbus Land Inn": MemoryLocation(0x3098, 6, True),
    ...
    "Goomba Thumping 1": MemoryLocation(0x3099, 4, True),
    "Goomba Thumping 2": MemoryLocation(0x3099, 5, True),
    "Cricket Pie Reward": MemoryLocation(0x3051, 2, False),
    "Cricket Jam Reward": MemoryLocation(0x3051, 3, True),
    "Hammer Bros": MemoryLocation(0x3052, 6, False),
    "Croco 1 (Boss)": MemoryLocation(0x304D, 3, True),
    "Mack": MemoryLocation(0x3082, 0, True),
    "Pandorite": MemoryLocation(0x3057, 5, True),
    "Belome 1": MemoryLocation(0x3055, 2, False),
    "Bowyer": MemoryLocation(0x3083, 6, True),
    "Croco 2 (Boss)": MemoryLocation(0x3056, 5, False),
    "Punchinello": MemoryLocation(0x3056, 3, False),
    "Booster": MemoryLocation(0x3053, 4, True),
    "Clown Bros": MemoryLocation(0x3048, 6, True),
    "Bundt": MemoryLocation(0x304C, 6, True),
    "Star Hill": MemoryLocation(0x308B, 5, True),
    "King Calamari": MemoryLocation(0x3058, 6, True),
    "Hidon": MemoryLocation(0x3057, 7, False),
    "Johnny": MemoryLocation(0x3058, 7, True),
    "Yaridovich": MemoryLocation(0x3086, 0, True),
    "Belome 2": MemoryLocation(0x307C, 5, False),
    "Jagger": MemoryLocation(0x308A, 2, True),
    "Jinx 1": MemoryLocation(0x308A, 3, True),
    "Jinx 2": MemoryLocation(0x308A, 4, True),
    "Jinx 3 (Boss)": MemoryLocation(0x308A, 5, True),
    "Culex": MemoryLocation(0x3093, 4, True),
    "Box Boy": MemoryLocation(0x3064, 6, True),
    "Mega Smilax": MemoryLocation(0x308C, 3, True),
    "Dodo": MemoryLocation(0x3092, 7, True),
    "Birdo (Boss)": MemoryLocation(0x305F, 5, False),
    "Valentina": MemoryLocation(0x304A, 2, True),
    "Czar Dragon": MemoryLocation(0x307E, 0, False),
    "Axem Rangers": MemoryLocation(0x307D, 7, True),
    "Magikoopa": MemoryLocation(0x3093, 6, True),
    "Boomer": MemoryLocation(0x3054, 2, False),
    "Exor": MemoryLocation(0x3093, 7, False),
    "Countdown": MemoryLocation(0x308F, 7, True),
    "Cloaker and Domino": MemoryLocation(0x3096, 0, False),
    "Clerk": MemoryLocation(0x3059, 4, True),
    "Manager": MemoryLocation(0x3091, 3, True),
    "Director": MemoryLocation(0x2E8E, 5, True),
    "Gunyolk": MemoryLocation(0x308F, 6, False),
    "Smithy": MemoryLocation(0x304A, 2, True),
})
