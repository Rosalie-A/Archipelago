...
class HELPMENUOut(PS1File, CompressibleTextFile):
    start_sector = 2256
    ...
    job_descriptions_offset = 0x5258
    ...
    skillset_descriptions_offset: int = 0x156B4
    ...
    def apply_transmooglifier_data(self):
        ...
        self.all_data[
            self.skillset_descriptions_offset:self.skillset_descriptions_offset + self.skillset_descriptions_length] = skillset_descriptions_result