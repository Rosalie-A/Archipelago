...
GerminasPeakNorth1.name = 'Germinas Peak North 1'
GerminasPeakNorth2.name = 'Germinas Peak North 2'
GerminasPeakNorth3.name = 'Germinas Peak North 3'
GerminasPeakNorth4.name = 'Germinas Peak North 4'
GerminasPeakSouth1.name = 'Germinas Peak South 1'
GerminasPeakSouth2.name = 'Germinas Peak South 2'
GerminasPeakSouth3.name = 'Germinas Peak South 3'
GerminasPeakSouth4.name = 'Germinas Peak South 4'
