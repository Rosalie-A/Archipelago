...
monster_job_name_lookup = {
    FactoryKey.YELLOW_CHOCOBO: MonsterNames.YELLOW_CHOCOBO,
    FactoryKey.BLACK_CHOCOBO: MonsterNames.BLACK_CHOCOBO,
    FactoryKey.RED_CHOCOBO: MonsterNames.RED_CHOCOBO,
    FactoryKey.GOBLIN: MonsterNames.GOBLIN,
    FactoryKey.BLACK_GOBLIN: MonsterNames.BLACK_GOBLIN,
    FactoryKey.GOBBLEDEGUCK: MonsterNames.GOBBLEDEGUCK,
    FactoryKey.BOMB: MonsterNames.BOMB,
    FactoryKey.GRENADE: MonsterNames.GRENADE,
    FactoryKey.EXPLOSIVE: MonsterNames.EXPLOSIVE,
    FactoryKey.RED_PANTHER: MonsterNames.RED_PANTHER,
    FactoryKey.CUAR: MonsterNames.CUAR,
    FactoryKey.VAMPIRE: MonsterNames.VAMPIRE,
    FactoryKey.PISCO_DEMON: MonsterNames.PISCO_DEMON,
    FactoryKey.SQUIDLARKIN: MonsterNames.SQUIDLARKIN,
    FactoryKey.MINDFLARE: MonsterNames.MINDFLARE,
    FactoryKey.SKELETON: MonsterNames.SKELETON,
    FactoryKey.BONE_SNATCH: MonsterNames.BONE_SNATCH,
    FactoryKey.LIVING_BONE: MonsterNames.LIVING_BONE,
    FactoryKey.GHOUL: MonsterNames.GHOUL,
    FactoryKey.GUST: MonsterNames.GUST,
    FactoryKey.REVNANT: MonsterNames.REVNANT,
    FactoryKey.FLOTIBALL: MonsterNames.FLOATIBALL,
    FactoryKey.AHRIMAN: MonsterNames.AHRIMAN,
    FactoryKey.PLAGUE: MonsterNames.PLAGUE,
    FactoryKey.JURAVIS: MonsterNames.JURAVIS,
    FactoryKey.STEEL_HAWK: MonsterNames.STEEL_HAWK,
    FactoryKey.COCATORIS: MonsterNames.COCATORIS,
    FactoryKey.URIBO: MonsterNames.URIBO,
    FactoryKey.PORKY: MonsterNames.PORKY,
    FactoryKey.WILDBOW: MonsterNames.WILDBOW,
    FactoryKey.WOODMAN: MonsterNames.WOODMAN,
    FactoryKey.TRENT: MonsterNames.TRENT,
    FactoryKey.TAIJU: MonsterNames.TAIJU,
    FactoryKey.BULL_DEMON: MonsterNames.BULL_DEMON,
    FactoryKey.MINITAURUS: MonsterNames.MINITAURUS,
    FactoryKey.SACRED: MonsterNames.SACRED,
    FactoryKey.MORBOL: MonsterNames.MORBOL,
    FactoryKey.OCHU: MonsterNames.OCHU,
    FactoryKey.GREAT_MORBOL: MonsterNames.GREAT_MORBOL,
    FactoryKey.BEHEMOTH: MonsterNames.BEHEMOTH,
    FactoryKey.KING_BEHEMOTH: MonsterNames.KING_BEHEMOTH,
    FactoryKey.DARK_BEHEMOTH: MonsterNames.DARK_BEHEMOTH,
    FactoryKey.DRAGON: MonsterNames.DRAGON,
    FactoryKey.BLUE_DRAGON: MonsterNames.BLUE_DRAGON,
    FactoryKey.RED_DRAGON: MonsterNames.RED_DRAGON,
    FactoryKey.HYUDRA: MonsterNames.HYUDRA,
    FactoryKey.HYDRA: MonsterNames.HYDRA,
    FactoryKey.TIAMAT: MonsterNames.TIAMAT,
}